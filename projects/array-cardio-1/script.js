...
/*
let peopleUnderFifteen = inventors.filter(investor => {
  if (investor.year > 1499 && investor.year < 1600) {
    return true;
  }
});

console.table(peopleUnderFifteen);
*/
// Array.prototype.map()
...
/*
let sortedInventors = inventors.sort((first, last) =>
...
let sortedInvestors = inventors.sort(function (a, b) {
  let firstGuy = a.passed - a.year;
  let lastGuy = b.passed - b.year;
